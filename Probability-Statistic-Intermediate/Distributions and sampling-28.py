...
lowest_income = income["median_income"].idxmin()

lowest_income_county = income["county"][lowest_income] 
print(lowest_income_county)
county_500000_median_income = income[income["pop_over_25"] >= 500000]

lowest_county_500000 = county_500000_median_income["median_income"].idxmin()
lowest_income_high_pop_county = income["county"][lowest_county_500000]
...
random.seed(1)
sampling = [roll() for _ in range(100)]
plt.hist(sampling, bins = 6)
plt.show()

random.seed(1)
sampling_large = [roll() for _ in range(10000)]
plt.hist(sampling_large, bins = 6)
plt.show()
