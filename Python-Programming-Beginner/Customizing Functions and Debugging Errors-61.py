...
for string in tokenized_story:
    if string not in tokenized_vocabulary:
        misspelled_words.append(string.lower())
...
def spell_check(vocabulary_file, text_file, special_characters=[",",".","'",";","\n"]):
    ...
    text_file_read = open(text_file).read()
    tokenized_vocabulary = tokenize(vocabulary_file_read, special_characters)
    tokenized_text = tokenize(text_file_read, special_characters,True)
...
final_misspelled_words = spell_check(vocabulary_file="dictionary.txt", text_file="story.txt", special_characters=True)
print(final_misspelled_words)