...
c_women = (0/255, 107/255, 164/255)
c_men = (255/255, 128/255, 14/255)
fig = plt.figure(figsize=(12, 12))
...
for sp in range(0,4):
    ax = fig.add_subplot(2,2,sp+1)
    ax.plot(women_degrees["Year"],women_degrees[major_cats[sp]],c = c_women, label = "Women")
    ax.plot(women_degrees["Year"], 100-women_degrees[major_cats[sp]],c = c_men, label = "Men")
    ax.tick_params(bottom="off", top="off", left="off", right="off")
    ax.set_xlim(1968,2011)
    ax.set_ylim(0,100)
